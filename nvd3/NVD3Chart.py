...
class NVD3Chart(object):
    ...
    def __init__(self, **kwargs):
        ...
        :keyword: **x_axis_scale_min** - default - ``''``.
        :keyword: **x_axis_scale_max** - default - ``''``.
        ...
        self.x_axis_scale_min = kwargs.get('x_axis_scale_min', '')
        self.x_axis_scale_max = kwargs.get('x_axis_scale_max', '')
